...
- **Global scope**: `/home/jmochel/pers/viracocha/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/jmochel/pers/viracocha/.cursor/notes/`)
...
2. Glob `/home/jmochel/pers/viracocha/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/home/jmochel/pers/viracocha/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/jmochel/pers/viracocha/.cursor/notes/` — works in any directory
