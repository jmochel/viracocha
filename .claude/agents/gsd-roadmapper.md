...
Reference full template: `/home/jmochel/pers/viracocha/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/jmochel/pers/viracocha/.claude/get-shit-done/templates/state.md`.
