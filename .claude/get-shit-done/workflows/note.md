...
- **Global scope**: `/home/jmochel/pers/viracocha/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/jmochel/pers/viracocha/.claude/notes/`)
...
2. Glob `/home/jmochel/pers/viracocha/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/jmochel/pers/viracocha/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/jmochel/pers/viracocha/.claude/notes/` — works in any directory
