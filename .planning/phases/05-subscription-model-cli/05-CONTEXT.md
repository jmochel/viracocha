...
- `src/main/java/org/saltations/model/PublisherEntry.java` — publisher name/path reference
...
- **`PublisherCommand`** / **`ProjectCommand`** — picocli nested command group pattern for `SubscriptionCommand`.
...
- **`vira publisher list` subscriber counts** (PUB-v2-01) — optional enhancement; not required for Phase 5 minimum.
