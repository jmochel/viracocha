# Requirements Archive: v2.0 Subscriptions & sync
...
**Core Value:** (from PROJECT.md) Register archetypes and catalogs once; generate safely; **keep published artifacts in sync with the workspace** via subscriptions.
...
| PAT-02a | `vira archetype unregister` warns when archetype still referenced |
